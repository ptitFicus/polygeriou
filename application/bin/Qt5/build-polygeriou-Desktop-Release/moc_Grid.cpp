...
QT_MOC_LITERAL(4, 23, 1),
QT_MOC_LITERAL(5, 25, 15)
    },
    "Grid\0contentChanged\0\0x\0y\0iterationFailed\0"
};
...
static const uint qt_meta_data_Grid[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::Int, QMetaType::Int, QMetaType::Char,    3,    4,    2,
...
void Grid::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->contentChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< char(*)>(_a[3]))); break;
        case 1: _t->iterationFailed((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Grid::*_t)(int , int , char );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Grid::contentChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Grid::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Grid::iterationFailed)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Grid::contentChanged(int _t1, int _t2, char _t3)
{
...
// SIGNAL 1
void Grid::iterationFailed(int _t1)
{
